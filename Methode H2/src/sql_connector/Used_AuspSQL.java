...
public class Used_AuspSQL {
	...
	public static  void set_usedAusp(int idMontOP,int idAuspr, double ratingFM,double ratingFR,boolean relevant, int gewichtung) {
		...
		//String query= "insert into kriterienkatalog.used_auspr  (idMontOP,idAuspr,ratingFM,ratingFR, relevant,gewichtung) values(?,?,?,?,?,?)";
	...
	public static  int get_lastusedAuspID() {
		...
		String query= "SELECT max(idused_Auspr) FROM used_auspr ";
	...
	public static  int get_minAuspID(int opID) {
		...
		String query= "SELECT min(idused_Auspr) FROM used_auspr where idMontOP=?;";
	...
	public static  int get_maxAuspID(int opID) {
		...
		String query= "SELECT max(idused_Auspr) FROM used_auspr where idMontOP=?;";
	...
	public static  ArrayList<Used_auspr> giveRelevant(int opID) {
		...
		Statement stmt = null;
		ResultSet rs = null;
		String query= "SELECT * FROM used_auspr where relevant=1 and idMontOP=?;";
	...
	public static  void update_Relevant(boolean relevant ,int usedAusPrId) {
		...
		String query1= "update used_auspr set relevant=? where idused_Auspr=?;";
		try {
	...
	public static  void update_Gewichtung(int weight ,int usedAusPrId) {
		...
		String query= "update used_auspr set gewichtung=? where idused_Auspr=?  and relevant=1;";
		try {
	...
	public static   Used_auspr get_usedAuspr(int idUsedAuspr) {
		...
		String query= "select * FROM used_auspr   WHERE idused_Auspr =? ";
		try {
